...
END
        ...
        if @default_syntax == :styles
          ...
          opts.on('--sass',
            ...
            @options[:for_engine][:syntax] = :styles
          end
        end
...
END
        ...
        opts.on('-F', '--from FORMAT',
          ...
          unless [:css, :scss, :styles].include?(@options[:from])
        ...
        opts.on('-T', '--to FORMAT',
          ...
          unless [:scss, :styles].include?(@options[:to])
